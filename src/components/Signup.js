    ...
    <div>
      <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
        ...
        <form onSubmit={handleSubmit} >
          <h2>Create your account to continue to NoteMe</h2>
          <div className="mb-3">
          ...
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }} >
            ...
            <button type="submit" className="btn btn-primary" style={{ backgroundColor: "black", color: "white", border: "black" }} >Create Account</button>
          </div>
        </form>
      </div>
    </div>
